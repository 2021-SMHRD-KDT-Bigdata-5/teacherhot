...
<body>
   ...
   <div class="header">
      <a class="logo" href="index.jsp"><img
         src="assets/css/img3/logo.png"></a>
   ...
   <div id="banner">
      <div class="inner">
         <div class="title" style="border-width:medium;">Q&A</div>
         
         <div class="content">
         <br> <br>영양제에 관련된 문의사항에 대하여 빠른 시간 내에 답해드립니다.<br> <br><br> <br>
            영양제를 섭취하면서 생기는 궁금증들이 많을 것이라 생각해요.<br> <br> 누구나 처음 영양제를 섭취
            할 때 겪는 어려움 중 하나죠.<br> <br> 그래서 Health plus는 고객님들의 눈높이에 맞추어
            Q&A창을 제작하게 되었어요. 
         </div>
         <br> <br>
         <div class="actions">
         
               <button style="height: 40px;"><a href="form.jsp" class="button primary" >질문하기</a></button>
                </div>
      </div>
   </div>
   <!-- <section>
      <h4>Buttons</h4>
      <ul class="actions">
         <li><a href="#" class="button">질문하기</a></li>
      </ul>
   </section> -->
   <!-- 메뉴 -->
   <%-- <nav id="nav">
   ...
   <div class="innerqna">
      ...
      <div class="add3">
         ...
         <div class="contentGeneric2">
            <br> <br> Q. 현재 진통제를 복용하고 있는데 비타민제와 함께 복용해도 될까요?<br>
            <br> A. 진통제와 비타민제는 서로 큰 영향을 미치지 않습니다.<br> <br>다만 몸에
            부담을 덜기 위해 1시간 정도 간격을 두고 섭취해주시는 것이 좋아요. <br> <br> <br> <br>
            Q. 현재 다이어트약(가르시니아)을 복용하고 있는데 밀크씨슬과 함께 복용해도 될까요?<br> <br>
            A. 두 가지 모두 간과 관련되어있는 약품이라 고민이 되셨다고 생각합니다. 같이 복용해도 간에 큰 무리가<br>
            <br> 되지는 않지만, 가르시니아는 식전에 밀크씨슬은 식후에 섭취하시는 것을 추천드립니다.<br> <br> <br>
            <br> 더 궁금한 점이 있다면 아래 FORM을 통하여 궁금한 질문을 보내주세요 :) <br> <br>
         </div>
         <br> <br>
      </div>
   </div>
